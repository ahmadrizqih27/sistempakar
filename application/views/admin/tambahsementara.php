            ...
            <div class="col-lg-6">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  ...
                  <form class="form-horizontal" action="<?php echo base_url().'index.php/admin/tambah_nilaisementara/';?>" method="post" enctype="multipart/form-data">
                     
                      <div class="form-group"style="margin-left: 100px">
                          <label class="col-lg-10 control-label">Id dataset</label>
                            <div class="col-lg-5">
                              <input type="text" name="id_dataset">
                            </div>
                      </div>
                      <?php for ($i=0; $i < 27; $i++) { ?>  
                      <div class="form-group"style="margin-left: 100px">
